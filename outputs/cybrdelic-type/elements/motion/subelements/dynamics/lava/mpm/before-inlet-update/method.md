...
- No new Mitsuba batch or GPU work was performed. The kernel surface remains
...
The physical scene also remains a finite cooling sample on a cold substrate.
It has no sustained incoming lava, so it cannot yet demonstrate a fed lava
front breaking through a crust. Increasing render samples cannot fix that.
