...
video=root.parent/'outputs'/'cybrdelic-firebending-intro.mp4'
...
sheet.save(root/'cybrdelic-review.jpg',quality=90)
(root/'cybrdelic-verification.json').write_text(json.dumps(meta,indent=2))
print(json.dumps({'video':str(video),'metadata':s,'decoded':'all frames','review':str(root/'cybrdelic-review.jpg')}))
