...
FPS=30
SIM_FPS=a.fps
DURATION=float(os.environ.get('INTRO_SECONDS','14.43'))
TOTAL=round(DURATION*FPS)
W,H=1920,1080
video=ROOT.parent/'outputs'/'cybrdelic-fire-gesture.mp4'
