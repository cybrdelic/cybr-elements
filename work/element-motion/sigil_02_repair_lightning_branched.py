...
def grow(event):
    dest=B/f'discharge-branched-{event:02}.npz'
    if dest.exists():
...
if __name__=='__main__':
    ...
    if '--full' not in sys.argv:
        ...
        sheet=sheet.crop((0,0,1440,540));sheet.save(B/'lightning-pilot-branched.jpg',quality=94);print('Pilot ready',flush=True);sys.exit(0)
