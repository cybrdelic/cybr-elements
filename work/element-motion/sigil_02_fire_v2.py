...
out = ROOT/'sigil-02-v2/fire-frames'
...
def step(t):
    ...
    sustained=(current*dt*2.5).clamp(0,1)
    inject=(front+sustained).clamp(0,1)
    fuel.lerp_(torch.ones_like(fuel)*.55,sustained)
...
TOTAL=294
W,H=1920,1080
video=ROOT/'sigil-02-v2/fire-02.mp4'
