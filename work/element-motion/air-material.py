...
W,H=1920,1080
video=ROOT.parent.parent/'outputs/cybrdelic-type/elements/motion/air-material.mp4'
...
def render(frame):
    ...
    rgb=sigma[...,None]*(lit*phase*.95+.10)[...,None]*torch.tensor([.66,.76,.83],device=device)
