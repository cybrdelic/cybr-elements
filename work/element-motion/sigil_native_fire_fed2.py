...
out = ROOT/'sigil-native/fire-c-fed2'
...
def step(t):
    ...
    if t>=2.4:reservoir.sub_(gas_inject).clamp_min_(0)
...
SIM_FPS=a.fps
DURATION=4.0
TOTAL=120 if a.pilot else round(DURATION*FPS)
W,H=1920,1080
video=ROOT/'sigil-native/fire-c-fed2.mp4'
