...
function wave(x,t){
 ...
 const ox=-.60*a*Math.cos(3.4*age),oz=-.40*b*Math.cos(4*age),stretch=1-.22*d;
 const vx=.60*a*(Math.cos(3.4*age)/.65+3.4*Math.sin(3.4*age));
 const vz=.40*b*(Math.cos(4*age)/.80+4*Math.sin(4*age));
 return [age,ox,oz,stretch,vx,vz,.22/.70*d];
}
