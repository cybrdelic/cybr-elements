...
R=Path(__file__).resolve().parent;O=R.parent.parent/'outputs/cybrdelic-type/elements/motion';cache=R/'bending-rebuild-v5/water-mesh-calibrated';manifest=json.loads((cache/'manifest.json').read_text());out=R/'bending-rebuild-v5/water-final-frames';out.mkdir(exist_ok=True)
