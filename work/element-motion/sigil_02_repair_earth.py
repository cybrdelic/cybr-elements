...
random.seed(6271);data=json.loads((R/'earth-geometry.json').read_text());out=R/('sigil-02-repair/earth-frames' if '--full' in sys.argv else 'sigil-02-repair/earth-pilot');out.mkdir(exist_ok=True)
