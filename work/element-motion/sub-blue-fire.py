...
out = ROOT/'subelements/blue-fire-frames'
...
def radiance():
    ...
    colors=torch.stack([.025+.62*hot.pow(3),.14+.72*hot.pow(1.5),torch.ones_like(hot)],dim=-1)
...
W,H=1920,1080
video=ROOT.parent.parent/'outputs/cybrdelic-type/elements/motion/subelements/blue-fire.mp4'
