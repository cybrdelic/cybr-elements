...
out = ROOT/f'sigil-native/fire-{VARIANT}-full'
...
def step(t):
    ...
    v=state[0,:3]
    v[0].lerp_(reservoir_dir[0]*2.8,(gas_inject*2).clamp(0,1));v[2].lerp_(reservoir_dir[1]*2.8,(gas_inject*2).clamp(0,1))
...
TOTAL=330
W,H=1920,1080
video=ROOT/f'sigil-native/fire-{VARIANT}-full.mp4'
