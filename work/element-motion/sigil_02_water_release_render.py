...
R=Path(__file__).resolve().parent;O=R.parent.parent/'outputs/cybrdelic-type/elements/motion';cache=R/'sigil-02-repair/water-release-mesh';out=R/('sigil-02-repair/water-release-frames' if '--full' in sys.argv else 'sigil-02-repair/water-pilot');out.mkdir(exist_ok=True)
