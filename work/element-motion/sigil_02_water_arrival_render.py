...
R=Path(__file__).resolve().parent;O=R.parent.parent/'outputs/cybrdelic-type/elements/motion';cache=R/'sigil-02-water-arrival/mesh';out=R/('sigil-02-water-arrival/frames' if '--full' in sys.argv else 'sigil-02-water-arrival/pilot');out.mkdir(exist_ok=True)
