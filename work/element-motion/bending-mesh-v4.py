...
B=R/'bending-rebuild-v4';source=B/'water-particles';out=B/'water-mesh-calibrated';out.mkdir(parents=True,exist_ok=True)
full='--full' in sys.argv;frames=range(120) if full else [42]
