...
progressdir=R/'progress-s64';progressdir.mkdir(exist_ok=True);progressfile=progressdir/f'{K}-{V}.json'
...
out=R/'frames'/f'{K}-{V}-s64';out.mkdir(parents=True,exist_ok=True)
