...
out = ROOT/'fire-material-v2-frames'
...
def radiance():
    ...
    emission=colors*(front*4.3)[...,None]
...
W,H=1920,1080
video=ROOT.parent.parent/'outputs/cybrdelic-type/elements/motion/fire-material-v2.mp4'
