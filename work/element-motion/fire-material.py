...
def radiance():
    ...
    front=reaction.clamp_min(0).pow(1.15)
    emission=colors*(front*2.7)[...,None]
...
W,H=1920,1080
video=ROOT.parent.parent/'outputs/cybrdelic-type/elements/motion/fire-material.mp4'
