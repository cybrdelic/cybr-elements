...
out = ROOT/'bending-rebuild/air-frames'
...
W,H=1920,1080
video=ROOT.parent.parent/'outputs/cybrdelic-type/elements/motion/bending/air.mp4'
...
(ROOT/'bending-rebuild/air-report.json').write_text(json.dumps({'frames':TOTAL,'fps':FPS,'size':[W,H],'solverGrid':a.size,'elapsed':time.monotonic()-started,'peakGpuMiB':torch.cuda.max_memory_allocated()/1048576,'source':'air-filaments.py','changes':'Moving tracer filaments with projected velocity and advection; extinction and directional volumetric lighting; no combustion or image fade.'},indent=2))
