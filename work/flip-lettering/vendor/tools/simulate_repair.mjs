...
const sourceFiles=['src/flip.js','src/flip-reference.js','src/flip-base.js','src/numerics/multigrid.js','src/numerics/stress.js','tools/simulate_repair.mjs'];
...
const manifest={schema:'cybr-flip-cache/3',name:outputName,preset:name,config,frameDt:1/48,frames:[],sourceHashes,solver:variant==='ii'?'src/flip-reference.js':'src/flip.js',
 ...
 simulationBackend:variant==='ii'?'CPU II affine FLIP reference':'CPU III.1 quadratic APIC/FLIP with Galerkin MG-PCG',createdAt:new Date().toISOString()};
