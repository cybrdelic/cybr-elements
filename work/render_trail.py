...
FPS=30
SIM_FPS=a.fps
DURATION=float(os.environ.get('INTRO_SECONDS','6.0'))
TOTAL=round(DURATION*FPS)
W,H=1920,1080
video=ROOT.parent/'outputs'/('fire-trail-study.mp4' if MODE=='arc' else 'cybrdelic-fire-trail.mp4')
